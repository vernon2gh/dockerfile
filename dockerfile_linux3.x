...
#### x86_64 ####
RUN apt-get install -y gcc g++ make libncurses-dev qemu bc rsync g++ patch wget unzip xz-utils
...
#### arm64 ####
RUN apt-get install -y pkg-config zlib1g-dev libglib2.0-dev autoconf libtool
RUN cd /opt \
